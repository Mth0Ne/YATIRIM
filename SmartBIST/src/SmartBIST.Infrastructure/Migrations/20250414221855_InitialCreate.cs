    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIStockPredictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIStockPredictions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AIStockPredictions_Stocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIStockPredictions_StockId",
                table: "AIStockPredictions",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_AIStockPredictions_UserId",
                table: "AIStockPredictions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicalIndicators_StockId_Type_Date",
                table: "TechnicalIndicators",
                columns: new[] { "StockId", "Type", "Date" });
